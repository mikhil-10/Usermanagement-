                ...
                <div class="col">
                    ...
                    <div class="mb-3">     
                        ...
                        <div class="mb-3">
                            ...
                            value="<?php echo $row['number']?>" placeholder="">
                            <small id="helpId" class="form-text text-muted">Help text</small>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            value="<?php echo $row['query']?>" placeholder="">
                            <small id="helpId" class="form-text text-muted">Help text</small>
                        </div>
                        <div class="mb-3">
                            <label for="" class="form-label">Reply</label>
                            <input type="text" class="form-control" name="reply" id="" aria-describedby="helpId"
                            value="<?php echo $row['reply']?>" placeholder="">
                            <small id="helpId" class="form-text text-muted">Help text</small>
                        </div>
