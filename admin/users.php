...
<body>
    ...
    <main>
        <div class="container border border-1 border-dark mt-5 col-sm-12 col-md-6">
            <h2 class="text-center pb-1 pt-2">User information</h2>
            <hr>
                    ...
                    >
                        ...
                        while ($row=mysqli_fetch_assoc($res)) {
                            ...
                            <tr class=''>
                                ...
                                <td>{$row['username']}</td>
                                <td>{$row['password']}</td>
                                <td><a name='' id=''  class='btn btn-warning' href='edit.php?id={$row['id']}' role='button' >Edit</a>
                                <a name='' id=''  class='btn btn-primary' href='delete.php?id={$row['id']}' role='button' >Delete</a>
                                </td>
                            </tr>";
                        }
                        echo "                               
